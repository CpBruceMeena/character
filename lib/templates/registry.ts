...
const categories: CategoryDefinition[] = [
  {
    ...
    templateIds: ["cartoon-base-a", "cartoon-pet"],
    order: 0,
  },
  {
    id: "fantasy",
    ...
    templateIds: ["fantasy-knight", "fantasy-elf"],
    order: 1,
  },
  {
    id: "sci-fi",
    ...
    templateIds: ["sci-fi-armor", "sci-fi-cyborg"],
    order: 2,
  },
  {
    id: "modern",
  ...
  },
  {
    ...
    templateIds: ["steampunk-explorer", "samurai", "victorian-gentleman"],
    order: 4,
  },
];
